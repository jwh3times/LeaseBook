...
namespace LeaseBook.Web.Migrations
{
    ...
    [Migration("20260803183554_M8_ReconcileCapabilitiesModelSnapshot")]
    partial class M8_ReconcileCapabilitiesModelSnapshot
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LeaseBook.Modules.Capabilities.Domain.Entitlement", b =>
                {
                    ...
                    b.HasIndex("OrgId", "Capability", "EffectiveAt")
                        .HasDatabaseName("ix_entitlements_org_id_capability_effective_at");
