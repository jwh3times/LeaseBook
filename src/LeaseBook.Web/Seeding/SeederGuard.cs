...
/// <summary>
/// Shared environment guard for the fixture seeders (demo, cutover, load, and any future fixture
/// org). Each provisions a well-known, source-committed admin password, so running any of them in
    ...
    public static void RequireNonProduction(IServiceProvider services)
    {
        ...
        if (environment.IsProduction())
        {
            throw new InvalidOperationException(
                "Fixture seeders (demo, cutover, load) ship a well-known admin password and must never run " +
