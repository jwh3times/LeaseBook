...
{
    public static bool Supports(AccountingEvent businessEvent) => businessEvent is
        RentCharged or FeeCharged or ManagementFeeAssessed or OwnerDisbursed;

    public static PostEntryRequest Build(AccountingEvent businessEvent) => businessEvent switch
    {
